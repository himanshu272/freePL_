    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day', models.DateField(default=datetime.datetime(2020, 3, 12, 22, 28, 7, 5271))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.PlayertoMatch')),
            ],
            options={
                'db_table': 'person_PM',
            },
